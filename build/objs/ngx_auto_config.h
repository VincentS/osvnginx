#define NGX_CONFIGURE " --prefix=/nginx --conf-path=/nginx/conf/nginx.conf --sbin-path=/nginx/nginx --pid-path=/tmp/nginx.pid --lock-path=/tmp/nginx.lock --error-log-path=/tmp/error.log --http-log-path=/tmp/access.log --http-client-body-temp-path=/tmp/client-body --http-proxy-temp-path=/tmp/proxy --http-fastcgi-temp-path=/tmp/fastcgi --http-scgi-temp-path=/tmp/scgi --http-uwsgi-temp-path=/tmp/uwsgi --with-cc-opt=-fPIC --with-ld-opt=-shared --without-http_rewrite_module"
...
#ifndef NGX_LITTLE_ENDIAN
#define NGX_LITTLE_ENDIAN  1
#endif
...
#define NGX_CONF_PREFIX  "/nginx/conf/"
#endif


#ifndef NGX_SBIN_PATH
#define NGX_SBIN_PATH  "/nginx/nginx"
#endif


#ifndef NGX_CONF_PATH
#define NGX_CONF_PATH  "/nginx/conf/nginx.conf"
#endif
...
#define NGX_ERROR_LOG_PATH  "/tmp/error.log"
#endif


#ifndef NGX_HTTP_LOG_PATH
#define NGX_HTTP_LOG_PATH  "/tmp/access.log"
#endif


#ifndef NGX_HTTP_CLIENT_TEMP_PATH
#define NGX_HTTP_CLIENT_TEMP_PATH  "/tmp/client-body"
#endif


#ifndef NGX_HTTP_PROXY_TEMP_PATH
#define NGX_HTTP_PROXY_TEMP_PATH  "/tmp/proxy"
#endif


#ifndef NGX_HTTP_FASTCGI_TEMP_PATH
#define NGX_HTTP_FASTCGI_TEMP_PATH  "/tmp/fastcgi"
#endif


#ifndef NGX_HTTP_UWSGI_TEMP_PATH
#define NGX_HTTP_UWSGI_TEMP_PATH  "/tmp/uwsgi"
#endif


#ifndef NGX_HTTP_SCGI_TEMP_PATH
#define NGX_HTTP_SCGI_TEMP_PATH  "/tmp/scgi"
#endif
